...
namespace XFramework.Editor
{
    ...
    public class SceneListWindow : EditorWindow
    {
        ...
        static SceneListWindow()
        {
            ...
            {
                string key = LastOpenKeyPrefix + scene.path;
        ...
        private void ConfigureListView()
        {
            ...
            sceneListView.bindItem = (element, i) => {
                ...
                // // 选中状态高亮
                // if (sceneListView.selectedIndex == i) {
                //     element.style.backgroundColor = new Color(0.18f, 0.38f, 0.58f, 0.7f); // 蓝色高亮
                //     labels.ForEach(l => l.style.color = Color.white);
                // } else {
                //     labels.ForEach(l => l.style.color = new Color(0.85f, 0.85f, 0.85f));
                // }
            };
