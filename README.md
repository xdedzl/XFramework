...
| **数据配置**       | [Runtime/Modules/Data/](./Runtime/Modules/Data/)         | [配表系统 (`XDataTable`)](./Doc/XDataTable.md)                                    |
...
- 完整专题文档：[`Doc/XDataTable.md`](./Doc/XDataTable.md)

适合用于统一维护配表资源绑定、主键/别名访问、首次加载后的索引构建，以及各类业务表的缓存使用约定。详细的基类职责、`AfterLoad()` 示例和访问方式，请直接阅读专题文档。
