...
public class GenerateGame
{
    ...
    {
        DirectoryInfo info = new DirectoryInfo(Application.dataPath + "/XFramework/XFrameworkGame");
        info = info.Exists ? info : new DirectoryInfo(Application.dataPath + "/XFrameworkGame");
        if (!info.Exists)
        {
