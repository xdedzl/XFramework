...
namespace XFramework.UI
{
    ...
    public interface PanelBaseWithRequest<out TRequest>: PanelBaseWithRequest where TRequest : struct
    {
        TRequest CreateDefaultOpenRequest();
    }
    ...
    public class PanelBase : MonoBehaviour, IComponentFindIgnore
    {
        ...
        internal void Init()
        {
            ...
            UIAutoBinder.Bind(this, m_ComponentFindHelper, typeof(PanelBase), "Panel");
            OnInit();
        }
    ...
    public abstract class PanelBase<TRequest> : PanelBase, PanelBaseWithRequest<TRequest> where TRequest : struct
    {
        public virtual TRequest CreateDefaultOpenRequest()
        {  
            return default;
        }
        ...
        {
            TRequest request = CreateDefaultOpenRequest();
            OpenRequest(in request);
        }
